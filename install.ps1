...
if (-Not (Check-Installed "nvcc")){
    ...
    Invoke-WebRequest -Uri "https://developer.download.nvidia.com/compute/cuda/10.2/Prod/network_installers/cuda_10.2.89_win10_network.exe" -OutFile "cuda-10.2.exe"
